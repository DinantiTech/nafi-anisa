...
export default function Footer() {
    return (
        <div className="w-full h-fit flex items-center justify-center text-center py-4 bg-amber-900 text-white text-xs leading-relaxed " style={{ backgroundImage: `url(${PATTERN_BATIK})`}}>
