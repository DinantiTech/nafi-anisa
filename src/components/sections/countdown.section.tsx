                    ...
                    <div className="absolute top-0 left-0 z-20 w-full h-full flex flex-col items-center justify-center xxs:gap-y-2">
                        ...
                        <div className="flex items-center justify-center xxs:gap-6 gap-3">
                            ...
                            <div className="xs:w-16 w-14 font-semibold cursor-pointer rounded-xl text-center xs:py-2 py-1 leading-snug text-white">
                                ...
                                <p className="text-sm xs:text-base sm:text-xl tracking-wide">Days</p>
                            </div>

                            <div className="xs:w-16 w-14 font-semibold cursor-pointer rounded-xl text-center xs:py-2 py-1 leading-snug text-white">
                                <h5 className="xs:text-2xl text-sm font-normal">{hours}</h5>
                                <p className="text-sm xs:text-base sm:text-xl tracking-wide">Hours</p>
                            </div>

                            <div className="xs:w-16 w-14 font-semibold cursor-pointer rounded-xl text-center xs:py-2 py-1 leading-snug text-white">
                                <h5 className="xs:text-2xl text-sm font-normal">{minutes}</h5>
                                <p className="text-sm xs:text-base sm:text-xl tracking-wide">Minutes</p>
                            </div>

                            <div className="xs:w-16 w-14 font-semibold cursor-pointer rounded-xl text-center xs:py-2 py-1 leading-snug text-white">
                                <h5 className="xs:text-2xl text-sm font-normal">{seconds}</h5>
                                <p className="text-sm xs:text-base sm:text-xl tracking-wide">Seconds</p>
                            </div>
                        </div>
                    </div>
