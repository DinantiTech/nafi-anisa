                    ...
                    <div key={idx} className="w-full bg-white">
                        <div className="flex items-center justify-between flex-col w-full h-60 p-6 border">
                            ...
                            <div className="flex items-center justify-between w-full">
                                ...
                                <button onClick={() => copyToClipboard({ value: data?.value, type: "REK" })} className="btn btn-sm sm:btn-md text-white flex items-center justify-center bg-[#E8B787] hover:bg-[#E8B787]/90 border-0 font-normal">
                                    <Icon className="text-lg" icon="solar:copy-line-duotone" />
                                    COPY
                                </button>
                            </div>
